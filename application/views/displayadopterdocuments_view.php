...
$(document).ready( function() {
    ...
    <div class="page-header">
        <h1>Adopter's Documents</h1>
    </div>
      <div class="well">

            <a href="<?php echo site_url('displayadopter').'/'.$adopter_num ?>">Go Back</a></br>
          ...
          <?php
            ...
            <tr>
             ...
             <a href="<?=$document['url']?>" target="_blank"><?=$document['url']?></a>
              ...
              <td>
                <a href="remove_document/<?=$adopter_num?>/<?=$document['id']?>">Remove</a>
              </td>
            </tr>
          <?php
            } ?>
    ...
    <h4>Upload Files</h4>
    <?php echo form_open_multipart('displayadopterdocuments'.'/'.$adopter_num);?>
