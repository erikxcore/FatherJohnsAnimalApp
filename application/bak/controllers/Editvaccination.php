...
class EditVaccination extends CI_Controller {
 ...
 function index($chart_num,$id)
 {
   ...
   {
     $this->edit_vaccination($this->input->post('id'),$this->input->post('vac_name'),$this->input->post('date_given'),$this->input->post('date_completed'));
 ...
 function edit_vaccination($id,$name,$date_given,$date_completed){
