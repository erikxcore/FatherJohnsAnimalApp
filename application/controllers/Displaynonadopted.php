...
class DisplayNonAdopted extends CI_Controller {
 ...
 $config["base_url"] = base_url() . "displaynonadopted";
    $config["total_rows"] = $this->animal->record_count_non_adopted();
    $config["per_page"] = 10;
    ...
    $allanimals = $this->animal->get_all_non_adopted_paged($config["per_page"], $page);
