...
class AddAnimal extends CI_Controller {
 ...
 function index()
 {
   ...
   if($this->session->userdata('superuser') != 1){
     ...
     $this->form_validation->set_rules('chart_num', 'Chart Number', 'trim|callback_alpha_dash_space|required');
     $this->form_validation->set_message('alpha_dash_space', 'Please only use numbers, dashes, spaces, and letters for chart number.');
     ...
     $this->form_validation->set_rules('acquired', 'Acquired By', 'trim|required');
 ...
 function add_animal($name,$chart_num,$run_num,$species,$breed,$date_of_arrival,$acquired,$acquired_how,$microchip_num,$age,$sex,$feeding_instructions,$status,$status_date,$behavior_strategy,$notes,$safer_complete,$medical_notes,$picture,$adopter){
    ...
    $result = $this->animal->add($name,$chart_num,$run_num,$species,$breed,$date_of_arrival,$acquired,$acquired_how,$microchip_num,$age,$sex,$feeding_instructions,$status,$status_date,$behavior_strategy,$notes,$safer_complete,$picture,$user,$date,$medical_notes,$adopter);
