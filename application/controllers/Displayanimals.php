...
class DisplayAnimals extends CI_Controller {
 ...
 function index()
 {
   ...
   else
   {
    ...
    $config["base_url"] = base_url() . "displayanimals";
    $config["total_rows"] = $this->animal->record_count_animals();
    $config["per_page"] = 10;
    ...
    $allanimals = $this->animal->get_all_animals_paged($config["per_page"], $page);
